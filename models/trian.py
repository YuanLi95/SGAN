    ...
    def _train(self, criterion, optimizer):
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            for i_batch, sample_batched in enumerate(self.train_data_loader):
                ...
                outputs,e_final  = self.model(inputs)
                attention.append(e_final)
                    ...
                    if test_f1 > max_test_f1:
                        ...
                        if self.opt.save and test_f1 > self.global_f1:
                            ...
                            torch.save(self.model,
                                       'state_dict/' + self.opt.model_name + '_' + self.opt.dataset+'_'+str(max_test_f1) + '.pkl')
    ...
    def _evaluate_acc_f1(self,criterion):
        ...
        with torch.no_grad():
            for t_batch, t_sample_batched in enumerate(self.test_data_loader):
                ...
                t_outputs,e_final = self.model(t_inputs)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='twitter', type=str, help='lap14,twitter, rest14, rest15, rest16')
    ...
    parser.add_argument('--edge_hidden_dim', default=300, type=int)
    ...
    parser.add_argument('--Syn_Layer',default=5,type=int)
